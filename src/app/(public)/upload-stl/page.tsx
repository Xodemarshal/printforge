  ...
  return (
    <div className="page-shell py-8 lg:py-10">
      <div className="mb-6 max-w-3xl">
        <p className="text-sm uppercase tracking-[0.3em] text-[#c5a059]">Special request</p>
        <h1 className="display-font mt-2 text-4xl text-[#c5a059] md:text-5xl font-bold">
          A special item for you
        </h1>
        <p className="mt-4 text-base leading-7 text-[#d9cfbf]">
      ...
      <div className="rounded-[34px] border border-[#8c6f42]/30 bg-white/5 backdrop-blur-md p-4 lg:p-6 shadow-[0_10px_24px_rgba(0,0,0,0.2)]">
        <div className="grid gap-5 lg:grid-cols-3">
          <div className="flex flex-col rounded-[28px] border border-[#8c6f42]/20 bg-black/30 p-6 text-[#f4ecd9]">
            <p className="text-xs uppercase tracking-[0.3em] text-[#c5a059]/80">Step 1</p>
            <h2 className="display-font mt-2 text-2xl font-bold text-[#c5a059]">Special item for you</h2>
          ...
          <div className="flex flex-col rounded-[28px] border border-[#8c6f42]/20 bg-black/30 p-5 text-[#f4ecd9]">
            <p className="text-xs uppercase tracking-[0.3em] text-[#c5a059]/80">Step 2</p>
            <h2 className="display-font mt-2 text-2xl font-bold text-[#c5a059]">What to upload</h2>
            ...
            <div className="mt-4 overflow-hidden rounded-[24px] border border-[#c5a059]/20 bg-black/40 p-3">
            ...
            <div className="mt-4 space-y-3">
              {INSPIRATION_POINTS.map((point, index) => (
                <div key={point} className="flex gap-3 rounded-2xl border border-[#c5a059]/20 bg-black/30 px-4 py-3">
                  <span className="grid h-8 w-8 shrink-0 place-items-center rounded-full bg-[#c5a059]/20 text-sm font-semibold text-[#c5a059]">
                    0{index + 1}
                  </span>
          ...
          <div className="flex flex-col rounded-[28px] border border-[#8c6f42]/20 bg-black/30 p-5 text-[#f4ecd9]">
            ...
            <h2 className="display-font mt-2 text-2xl font-bold text-[#c5a059]">How we use it</h2>
            <div className="mt-4 space-y-3">
              {PROCESS_STEPS.map((step, index) => (
                <div key={step.title} className="rounded-[22px] border border-[#c5a059]/20 bg-black/30 p-4">
                  <div className="flex items-center gap-3">
                    <span className="grid h-9 w-9 place-items-center rounded-full bg-[#c5a059]/20 text-sm font-semibold text-[#c5a059]">
                      {index + 1}
                    </span>
            ...
            <div className="mt-5 rounded-[22px] border border-[#c5a059]/20 bg-black/30 p-4 text-[#f4ecd9]">
              <p className="text-xs uppercase tracking-[0.24em] text-[#c5a059]">What you get</p>
            ...
            <div className="mt-4 grid gap-2 sm:grid-cols-2">
              <div className="rounded-2xl border border-[#c5a059]/20 bg-black/30 px-4 py-3 text-sm">
