    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <Link href="/admin/shipping/not-picked-up"
          className="inline-flex items-center gap-2 text-sm bg-gray-900 border border-gray-800 text-gray-300 px-4 py-2 rounded-xl hover:text-white hover:border-gray-700 transition-colors">
          <Truck size={14} /> Not Picked Up Queue
        </Link>
      </div>
