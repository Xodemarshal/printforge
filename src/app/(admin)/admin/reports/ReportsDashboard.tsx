  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <h1 className="text-3xl font-bold text-white">Reports & Automation</h1>
        <p className="text-gray-400 text-sm mt-1">Configure automated scheduled reports and email digests.</p>
      </div>
