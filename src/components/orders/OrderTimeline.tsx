...
export function OrderTimeline({
  ...
  return (
    <div className="space-y-4">
      <div>
        <p className="mb-2 text-[10px] font-bold uppercase tracking-[0.3em] text-cream/50">Order Status</p>
      ...
      {isAutomatic && shipmentIndex >= 0 && (
        <div>
          <p className="mb-2 text-[10px] font-bold uppercase tracking-[0.3em] text-cream/50">Delivery Timeline</p>
          <div className="flex flex-wrap gap-2">
