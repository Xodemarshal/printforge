      ...
      <div className="page-shell">
        <div className="panel-premium rounded-[48px] p-3 lg:p-4">
          <div className="grid gap-6 lg:grid-cols-[1.1fr_1fr_0.9fr]">
            ...
            {/* Core Narrative */}
            <div className="flex flex-col justify-center gap-10 rounded-[40px] panel-alabaster p-8 lg:p-16">
              ...
              <div className="mt-6 grid grid-cols-2 gap-8 border-t border-forest/15 pt-10">
                ...
                <div className="space-y-1 border-l border-forest/15 pl-8">
              ...
              {FEATURED_ITEMS.map((item, idx) => (
                <div
                  ...
                  className={`card-artisan group h-full min-h-[180px] lg:min-h-[240px] ${
                    idx === 1 || idx === 2 ? 'translate-y-6 lg:translate-y-10' : ''
                  }`}
                >
                  <div className="absolute inset-0">
                    ...
                    />
                    <div className="forest-gradient-overlay" />
                  </div>
                  
                  <div className="forest-inner-border" />
                  
                  <button
                    type="button"
                    className="absolute right-5 top-5 z-10 h-10 w-10 rounded-full bg-white/10 backdrop-blur-md text-forest transition-all duration-300 hover:bg-forest hover:text-white"
                  >
